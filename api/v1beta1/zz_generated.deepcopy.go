...
func (in *ScvmmProviderSpec) DeepCopyInto(out *ScvmmProviderSpec) {
	*out = *in
	...
	if in.DomainSecret != nil {
		in, out := &in.DomainSecret, &out.DomainSecret
		*out = new(v1.SecretReference)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VmPoolName) DeepCopyInto(out *VmPoolName) {
	*out = *in
	if in.Owner != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VmPoolName.
func (in *VmPoolName) DeepCopy() *VmPoolName {
	if in == nil {
		return nil
	}
	out := new(VmPoolName)
